...
export default function CreateAd({ form, regions, cities, onChange, onSubmit }) {
  // eslint-disable-next-line react/prop-types
  const { title, description, from, to, region, city } = form;
  ...
  const renderRegions = useCallback(() => {
    ...
    // eslint-disable-next-line react/prop-types
    return regions.map(({id, region, value}) => {
